...
class TestFileStorage(unittest.TestCase):
    ...
    def help_test_all(self, classname):
        """Help test all() method for classname."""
        self.resetStorage()
    ...
    def help_test_all_multiple(self, classname):
        """Help test all() method with many objects for classname."""
        self.resetStorage()
        self.assertEqual(storage.all(), {})
    ...
    def help_test_new(self, classname):
        """Help test new() method for classname."""
        self.resetStorage()
        cls = storage.classes()[classname]
        o = cls()
        storage.new(o)
    ...
    def help_test_save(self, classname):
        """Help tests save() method for classname."""
        self.resetStorage()
        cls = storage.classes()[classname]
        o = cls()
        storage.new(o)
    ...
    def help_test_reload(self, classname):
        """Help test reload() method for classname."""
        self.resetStorage()
        storage.reload()
    ...
    def test_5_reload_excess_args(self):
        """Test reload() with too many arguments."""
        self.resetStorage()
        with self.assertRaises(TypeError) as e:
